...
var dialogues = {
	[0,0] : "Voici le logiciel. Maintenant essaie d'envoyer un message non chiffré à Bob et de le lire.",
	...
	[4,1] : "Tu peux continuer d'utiliser l'ordinateur, éteins-le quand tu as fini."
}
