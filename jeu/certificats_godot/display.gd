...
func text_mail(etape, doss):
	if etape==0 :
		...
		txt_mail.text = "Qu’est-ce que tu fais? Cela fait 1 semaine que je vois les demandes de certification s’empiler sur ton bureau sans qu’aucune soit traitée, tu as intérêt à commencer à t’activer.\n
		Bosse.\n
		...
		env.text = "B";
		var txt_mail= get_node("mail/Scroll/contenu");
		txt_mail.text = "Bien. Je vois que tu as bien exploré ma page. Cependant, maintenant, tu en sais trop. Dommage, t'avais l'air plutôt compétent, on se recroiserapeut-être dans une autre vie!"
