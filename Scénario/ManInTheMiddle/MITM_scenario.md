...
- Ils ont des sujets de conversation pour se faire comprendre qui ils sont. On sait que Bob est sensé parler de quelque chose qui ressemble à une tour à Versailles, de boissons, et des gros titres du journal. On ne connaît pas les sujets que Alice devra aborder, donc retiens bien ce qu'elle dit, car tu devras ensuite te faire passer pour elle ! En résumé, trouve Alice, fais toi passer pour Bob, prends le cahier, copie le, puis rends le à Bob en te faisant passer pour Alice. Veux tu que je te rappelle {le principe, à quoi ressemble Alice, ce qu'il faut faire pour se faire passer par Bob, ce qu'il faut retenir} ?
- Non, c'est tout bon. Merci.

## 2e moitié du scénario, rédigé
Le joueur va donc au lieu de rendez vous. Il voit l'espion habillé d'une manière particulière(pantalon rouge et chemise noire, masque de carnaval pour ne pas paraître trop suspicieux, cheveux longs noirs, chapeau melon, gant rouges, veston rouge en tant que manteau, chaussures noires) assis à une tablea près d'une fenêtre.  Le dialogue est comme suit :  
- Choix 1 : 
	* Bonjour. Belle journée pour parler de la tour de Versailles ! (bon choix)
	* Vous savez, j'adore les anchoix.
	* Que pensez-vous de la politique du Roi?
	* Êtes-vous un.e espion.ne? -> peut-être tunnel sur le manque de finnesse

-> Réponse : La... tour de Versailles ?
- Choix 2 :  
	* Oui, la *tour* de *Versailles* petit mouvement de sourcil (bonne réponse)
	* Je voulais dire le... clocher de Versailles ! (bonne réponse)
	* Vous avez raison, la tour de *Pise* est plus belle encore ! petit mouvement de sourcil (bonne réponse)
	* Désolé je me suis trompé, vous n'êtes pas la personne que je cherche, celleque je cherhce est spécialiste des tours, ce qui n'est clairement pas votre cas! -> n'a pas compris la mission....

-> Réponse : Mais bien sûr ! je préfère boire de la bière, et vous ?
- Choix 3 :
	* C'est pratique quand on travaille dans la *construction* (bonne réponse)
	* Oui (mauvaise réponse, mais permet a do-over, espion demande : pardon et les mêmes choix s'affichent, au 2ème raté l'espion part)
	* Non (mauvaise réponse, mais permet a do-over, espion demande : pardon et les mêmes choix s'affichent, au 2ème raté l'espion part)
	* Les oiseaux adorent le printemps vous savez! (mauvaise réponse)

-> Réponse : _acquiesce_ 
- Choix 4 : 
	* Avez-vous vu les gros titres de ce matin ? (bonne réponse)
	* Êtes-vous vraiment suuuuuuuuuuuur d'avoir vu la tour? -> mauvaise réponse + pas fin
	* _acquiesce_ (lance une boucle d'acquiescements, pour explosion des crânes car ils ont trop acquiescé(éventuel))

-> Réponse : Parlez-vous de ce nouveau décret royal sur les espions ? (oh non, il parle d'espions, c'est un piège ! ma réaction :) 
- Choix 5 : 
	* Je fuis (mauvais choix)
	* Je prends un air soupçonneux -genre c'est moi qui le prend pour un espion (mauvais choix)
	* je pleure en avouant tout (mauvais choix) -> peut-être tunnel sur le manque de finnesse
	* Je reste de marbre (bonne réponse)
	
Alice s'en va en laissant le livre sur la table.  
...
On le voit avec son reflet dans la glace, style dress-up game : pour chaque partie du corps (tête, mains, torse, jambes, pieds), il a plusieurs (3-4) propositions de vêtements (respectivement chapeaux/moustache, gants, manteaux, pantalons, chaussures, perruque). Il valide ce qu'il a choisi 
...
+ choisir la bonne table où s'asseoir (la même que l'espion la première fois)
+  Dire à nouveau EXACTEMENT toutes les phrases de l'espion peut importe ce que la victime répond (encore une fois discussion à choix) : 
	- [Victime] :Bonjour. Belle journée pour parler de la tour de Versailles !
		* La... tour de Versailles ? 
		* Vous voulez dire la tour de matignon, non?
		* Pfff, elle est dépassée
		* J'aime que les pâtes. C'est tout.
	- [Victime] :Oui, la *tour* de *Versailles* petit mouvement de sourcil
		* Mais bien sûr ! je préfère boire de la bière, et vous ? 
		* Ah. Oui. .... _silence_
		* Balivernes que tout cela!
	- [Victime] : C'est pratique quand on travaille dans la *construction*
		* (acquiescer) 
		* faire non de la tête
		* tomber de sa chaise
		* partir
	- [Victime] : Avez-vous vu les gros titres de ce matin ?
		* Parlez-vous de ce nouveau décret royal sur les espions ? 
		* Faites-vous référence aux promotions sur les légumes de la ferme de Courchevelle?
		* Je ne lis pas cette paperasse, pour moi, ce ne sont que des attrape-nigauds!
		* J'aime bien le papier, donc les journaux.
	- [Victime] : _reste de marbre_
		* (je m'en vais en laissant le cahier)
		* je tombe de ma chaise
		* Je hurle : alerte, c'est un espion en le pointant du doigt -> manque de finesse + se fait arrêté car comment connaissait-il le code des espions pour le démasquer sans être lui-même espion?
		* bataille de regard (idem, crânes explosent)
...
Ordre du Roi : Mettre en prison M. Ann Onyme.
...
une fis qu'il a rédigé/modifié ce message, le joueur est téléporté à l'époque suivante, il a accompli sa mission
